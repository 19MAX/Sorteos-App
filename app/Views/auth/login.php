...
<div class="text-center mb-3">
    <a href="index.html" class="mb-4 d-inline-block"><img
            ...
            alt="" width="36">
        <span class=" ms-2 fw-bold text-uppercase text-primary h3">
...
<form class="needs-validation mt-3" method="POST" action="<?= site_url('/login') ?>" novalidate>
    <div class="mb-3">
        ...
        <input id="username" name="username" type="text" class="form-control" placeholder="Ingrese su nombre de usuario"
            required autofocus>
